...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/03/10 19:47:00 by wshoweky          #+#    #+#             */
/*   Updated: 2026/03/10 19:47:02 by wshoweky         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_texture* find_texture_by_name(t_scene* scene, const char* name) {
	...
	while (i < scene->assets.tex_count) {
		if (scene->assets.textures[i].loaded && ft_strcmp(scene->assets.textures[i].name, name) == 0)
